...
- v1.2.2 新增兩店 2026/08/31–09/06 與 2026/09/07–09/13 的店舖總覽、父商品明細，共 8 份週資料；連同 7、8 月歷史檔，累計保留 16 份 checkpoint。
- 首頁使用最新完整 7 天與前一完整 7 天比較；不把兩個週檔的人數直接相加，避免同一位跨週訪客被重複計算。
